...
var displayMap = function displayMap(locations) {
  var accessToken = 'pk.eyJ1IjoiYWFtaXItYWxpaSIsImEiOiJjbGV2NW56c2kwbDNsM3Zta2phNWdwdmtpIn0.LyRZee2QYWLzhZ1N17cT0g';
...
var updateSetting = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(userData, type) {
    var url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          url = type === 'data' ? 'http://localhost:8000/api/v1/users/updateme' : 'http://localhost:8000/api/v1/users//updatemypassword';
          _context.next = 5;
          return (0, _axios.default)({
            url: url,
            method: 'PATCH',
        ...
        case 5:
          res = _context.sent;
          (0, _alerts.showAlert)('success', "".concat(type[0].toUpperCase() + type.slice(1), " updated successfully"));
          if (type === 'password') setTimeout(_alerts.hideAlert, 5000);
          _context.next = 14;
          break;
        case 10:
          _context.prev = 10;
          _context.t0 = _context["catch"](1);
          (0, _alerts.showAlert)('error', _context.t0.response.data.message);
          setTimeout(_alerts.hideAlert, 5000);
        case 14:
        case "end":
          return _context.stop();
      }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51N5kcfSBF1x0nnlTZKkgviNoX5YtNf5mPEUxcUzADubnoqZ0QU7eSd1dqBkt06B1y7ofZxiqKhOrKvqBcwSo1cIi00lsTduWWu');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("http://localhost:8000/api/v1/bookings/session/".concat(tourId));
        case 3:
          res = _context.sent;
...
var _updateSetting = require("./updateSetting.js");
...
var userSettingForm = document.querySelector('.form-user-settings');
var bookTourElement = document.getElementById('book-tour');
// Delegations
if (photoElement) {
  photoElement.addEventListener('change', function () {
    var image = photoElement.files[0];
...
if (userSettingForm) {
  userSettingForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      var currPassword, password, passwordConfirm;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
            currPassword = document.getElementById('password-current').value;
...
if (bookTourElement) {
  bookTourElement.addEventListener('click', /*#__PURE__*/function () {
